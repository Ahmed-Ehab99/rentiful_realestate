...
const DiscoverSection = () => {
  return (
    <motion.div
      ...
      className="bg-white pt-12 pb-28"
    >
...
const DiscoverCard = ({
  ...
  <div className="bg-primary-50 flex h-full flex-col rounded-lg px-4 py-12 shadow-lg">
    <div className="bg-primary-700 mx-auto mb-4 size-10 rounded-full p-[0.6rem]">
      <Image
        src={imageSrc}
        width={30}
        height={30}
    ...
    <p className="mt-2 text-base text-gray-500 md:mt-auto lg:mt-2">
      {description}
    </p>
  </div>
);
