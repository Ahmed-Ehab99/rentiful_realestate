...
const FeaturesSection = () => {
  return (
    <motion.div
      ...
      className="bg-white px-8 pt-24 pb-12"
    >
...
const FeatureCard = ({
  ...
  <div className="flex h-full flex-col items-center text-center">
    ...
    <p className="mb-4 lg:mt-auto">{description}</p>
    <Link
      href={linkHref}
      className="mt-auto inline-block w-fit rounded border border-gray-300 px-4 py-2 hover:bg-gray-100 lg:mt-0"
      scroll={false}
    >
      {linkText}
    </Link>
